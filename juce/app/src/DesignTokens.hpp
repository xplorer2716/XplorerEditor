...
namespace xplorer::app::tokens
{
    ...
    namespace global
    {
        ...
        inline constexpr float progressBarLabelFontRatio = 0.6F;  // progress-bar percentage label font height, as a fraction of the bar's own height. Value-preserving from JUCE LookAndFeel_V4::drawLinearProgressBar's own literal, carried into XplorerLookAndFeel's override (RQ-GUI-078) which draws the label itself instead of leaving it to the JUCE default
    ...
    namespace semantic
    {
        ...
        inline constexpr float progressBarLabelFontRatio = global::progressBarLabelFontRatio;  // percentage-label font height, RQ-GUI-078
